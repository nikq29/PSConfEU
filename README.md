...
The `Test/` folder contains PowerShell scripts for each endpoint. By default they target the deployed function. Set environment variables to override:

| Variable | Default | Description |
|----------|---------|-------------|
| `FUNCTION_URL` | Deployed function URL | Base URL of the Function App |
| `FUNCTION_KEY` | Deployed function key | `x-functions-key` for authentication |

Examples:

```powershell
# List members of a group
./Test/GroupMember-GET.ps1 -GroupId "<group-guid>"

# Add a member
./Test/GroupMember-POST.ps1 -GroupId "<group-guid>" -UserPrincipalName "user@domain.com"

# Remove a member
./Test/GroupMember-DELETE.ps1 -GroupId "<group-guid>" -UserPrincipalName "user@domain.com"

# Create a group
./Test/Group-POST.ps1 -Name "My Group"

# Delete a group
./Test/Group-DELETE.ps1 -GroupId "<group-guid>"
```

To target a local instance:
